...
EVIDENCE_SCHEMA = "semantic-source-frame-evidence/v14"
INDEX_SCHEMA = "semantic-source-frame-evidence-index/v14"
PROPOSAL_SCHEMA = "semantic-candidate-proposal-index/v14"
...
def main(argv: list[str] | None = None) -> int:
    ...
    atomic_json(args.progress, {"schema": "semantic-source-frame-evidence-progress/v14", "total": len(proposals), "completed": completed, "remaining": len(proposals) - completed, "failed": failures, "updated_at": now_iso(), "extractor": "ffmpeg_accurate_decode", "wpf_evidence_accepted": False})
    if failures:
        return 2
