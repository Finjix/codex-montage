...
def build():
 ...
 semantic=COMPONENTS["semantic"]; active={"schema":"three-suite-semantic-active/v20","package_id":semantic["package_id"],"version":semantic["version"],"relative_path":"versions/semantic-analysis-training-backup-v20","tree_sha256":manifests["semantic"][1]["tree_sha256"],"interface":semantic["interface"],"activated_at":now}; atomic(ROOT/"02-语义分析包"/"active.json",active)
 runtime_files={
